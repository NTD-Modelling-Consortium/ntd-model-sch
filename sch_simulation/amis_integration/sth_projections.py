...
def wrap_function(iu):
    ...
    if species == "trichuris":
        ...
        coverageFileName = 'endgame_inputs/InputMDA_MTP_projections_trichuris_' + str(iu) + '.xlsx'
    else:
    ...
    '''
    RkFilePath = '~/NTDs/STH/post_AMIS_analysis/InputPars_MTP_' + str(species) + '/InputPars_MTP_' + str(iu) + '.csv'
...
if species == "trichuris":
    print("Reading list of IUs for projections for trichuris in batch " + str(id) + "...")
    path = 'sch_simulation/data/endgame_inputs/IUs_MTP_projections_trichuris_' + str(id) + '.csv'    
else:
    print("Reading list of IUs for projections for " + str(species) + " in batch " + str(id) + "...")
